...
2. **⚠️ CRITICAL: Install the package** (required for imports to work):
...
4. **Start developing** your domain-specific tools and functionality!

### Troubleshooting

- **ModuleNotFoundError** (e.g., `No module named 'your_project_name'`): You forgot to install the package after transformation. Run `pip install -e ".[dev]"` in your new project directory.
...
- **Script fails to clone**: Ensure you're running from outside the template directory
